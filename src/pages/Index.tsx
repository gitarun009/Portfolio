...
const Index = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "A responsive weather application built with HTML, CSS, JavaScript, and OpenWeatherMap API. Displays current weather information including temperature, humidity, and wind speed based on city names with a user-friendly interface.",
      image: "https://images.unsplash.com/photo-1592210454359-9043f067919b?w=600&h=400&fit=crop",
      technologies: ["HTML5", "CSS3", "JavaScript", "NodeJS", "OpenWeatherMap API"],
      githubUrl: "https://github.com/gitarun009/Weather-Website",
      liveUrl: "https://gitarun009.github.io/Weather-Website/"
    },
    {
      id: 3,
